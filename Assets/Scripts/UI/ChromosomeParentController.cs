...
public class ChromosomeParentController : MonoBehaviour
{
    ...
    {
        var info = ChromosomeController.GetSegmentLocation(ChromosomeController.GetSegmentFromCurrentChromosome(segmentSet, segmentSetIndex));
        ...
        var genePositions = ChromosomeController.chromosomeRenderingInfo.backbonePoints.GetRange(startIndex, endIndex - startIndex).Select((v) => v.position);
